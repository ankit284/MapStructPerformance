...
public class ClothesDTO {
	...
	public ClothesDTO(String pogId, String supc, String brand, String description, String size, String category,
	...
	public String toString() {
		return "ClothesDTO [pogId=" + pogId + ", supc=" + supc + ", brand=" + brand + ", description=" + description
